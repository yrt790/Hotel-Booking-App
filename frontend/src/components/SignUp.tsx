...
const SignUp = () => {
  ...
  return (
    <section className="w-1/2 mx-auto text-center">
      <h2 className="text-4xl font-bold pt-2">Sign Up</h2>
      <form className="mt-5 form-control">
        <section className="flex flex-col md:flex-row gap-2 ">
          <label className="w-full">
            ...
            <input
              type="text"
              className="input w-full lg:text-xl xl:2xl"
              required
            ></input>
          </label>
        ...
        <label>
          ...
          <div className="w-[105%] flex">
            <input
              type="password"
              className="input w-[100%] lg:text-xl xl:2xl"
              id="password"
              required
            ></input>
            <button
      ...
      <section className="mt-5">
        <p className="text-lg lg:text-xl xl:text-2xl">
          ...
          <Link to="/sign-in" className="underline hover:text-blue-400">
            Sign In
          </Link>
        </p>
      </section>
